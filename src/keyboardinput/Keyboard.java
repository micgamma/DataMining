...
/** Facilita l'inserimento da tastiera estraendo dettagli sull'input ,
 *  sulla conversione e la gestione delle eccezioni.
 */
public class Keyboard {
	// ************* Error Handling Section **************************
	
	/** Indica se è necessario stampare o meno gli errori */
	private static boolean printErrors = true;
	
	/** Numero di errori che si sono rilevati */
	private static int errorCount = 0;

	/**
	 * Ritorna il numero di errori rilevati
	...
	/** Riporta a zero il numero di errori rilevati */
	...
	// -----------------------------------------------------------------
	/**
	 * Restituisce un valore di verità che indica se gli errori di input devono essere stampati oppure no
	 * @return	Restituisce <b>true</b> se gli errori di input devono essere stampati , <b>false</b> altrimenti
	 */
	...
	/**
	 * Decide se stampare o meno gli errori in input 
	 * @param flag	Se <b>true<b> verranno stampati gli errori , se <b>false<b> no 
	 */
